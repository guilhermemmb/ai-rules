...
Use codebase-memory-mcp to map Gorgias metrics and business concepts back to
code implementation. Only for code mapping — Cortex stays the source of truth
for definitions.
