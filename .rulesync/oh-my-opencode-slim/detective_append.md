...
files, shell, edits, and source confirmation after production runtime
confirmation.

## Detective Sequence

Use production runtime confirmation followed by native source confirmation. Base
every finding on actual pup or GCP output.
