...
modifies state without explicit user confirmation. This is NOT overridable.

**Requires confirmation before running:**

- `gh pr create`, `gh pr merge`, `gh pr close`, `gh pr edit`, `gh pr comment`,
  `gh pr review`
...
stop and ask the user for explicit confirmation first**. This includes:
