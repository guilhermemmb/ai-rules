...
name: screenshot
description: |
  Generate beautiful screenshots of code, terminal output, shell commands, and inline snippets using charmbracelet/freeze. Four modes: code (file), snippet (inline text), command (execute & capture output), terminal (tmux pane capture).
metadata:
  version: 1.1.0
